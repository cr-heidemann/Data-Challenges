...
train_ds = torchvision.datasets.ImageFolder('coins4/train/', transform=ToTensor())
valid_ds = torchvision.datasets.ImageFolder('coins4/valid/', transform=ToTensor())
test_ds = torchvision.datasets.ImageFolder('coins4/test/', transform=ToTensor())
    ...
    for epoch in range(EPOCHS):        
      for step, (x, y) in enumerate(train_loader):
        ...
        if step % 50 == 0:
          ...
          s='Epoch: ' + str(epoch) + '| train loss: ' + str(loss) + '| test accuracy: ' + str(accuracy) + "\n"
          file.write(s)
