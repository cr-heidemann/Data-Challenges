...
ds = load_dataset("imagefolder", data_dir="DC-1")
print(ds)
...
from transformers import DeiTModel, DeiTImageProcessor, DeiTForImageClassification, AutoImageProcessor
...
training_args = TrainingArguments(
  output_dir="./models/1", # output directory
