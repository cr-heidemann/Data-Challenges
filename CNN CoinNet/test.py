...
#testset = dataset.loader(root='../../Dataset/Ancient_Coins/', is_train=False, data_len=None)
testset = dataset.loader(root='/home/heidemann/dc/CoinNet_model/Dataset/Ancient_Coins', is_train=False, data_len=None)
